...
class InputParameter(trapi.HasTraits):
    ...
    def _get_data_button_fired(self):
        ...
        self.correlpairs = [generate_correl_pair(correl_pair) for correl_pair in [
            'REP.MC - TEF.MC', 'REP.MC - TEF.MC', 'REP.MC - TEF.MC', 'REP.MC - TEF.MC',
            'REP.MC - TEF.MC', 'REP.MC - TEF.MC', 'REP.MC - TEF.MC', 'REP.MC - TEF.MC', 'BASKET CORREL']]
